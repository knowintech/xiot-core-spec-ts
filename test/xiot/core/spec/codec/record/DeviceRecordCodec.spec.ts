...
import {DeviceRecordCodec} from '../../../../../../src/xiot/core/spec/codec/record/DeviceRecordCodec';

describe('DeviceRecordCodec', async () => {

    const folder = './resources/record/device/';
    const dir = await fs.readdir(folder);
    const codec = new DeviceRecordCodec();
